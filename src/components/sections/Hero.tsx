...
const Hero = () => {
  ...
  return (
    <section className="relative px-3 py-2 ml-[-18px] md:ml-0 overflow-hidden">
      <WaveBackground />
      ...
      >
        ...
        <div className=" sm:text-left sm:mt-8 space-y-2 pr-4 mb-8 md:mb-8 lg:mb-8 sm:h-96 md:h-[430px] lg:h-[450px] flex flex-col justify-center items-center">
          <motion.div 
            className="text-center sm:text-left mb-4 pl-4 pr-2 sm:mb-6 md:mb-4 lg:mb-8 sm:mt-16 md:mt-16 lg:mt-18 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-playfair text-blue-950"
