...
const Planes = () => {
  ...
  return (
     <section id='servicios' className="py-10 sm:py-18 md:py-20 lg:py-24 px-8 bg-gradient-to-br from-cyan-100/15 to-blue-50/30">
      <div className="max-w-7xl mx-auto">
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <motion.div
            ...
            className="w-20 h-20 bg-electric-blue/10 rounded-full flex items-center justify-center mx-auto mb-6"
          >
